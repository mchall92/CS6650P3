...
public class KVServer1 {

    private static ServerLogger serverLogger = new ServerLogger("KVServer1");
    ...
    public static void main(String[] args) {
        ...
        try {
            KVServant kvServer1 = new KVServant();
            KVInterface kvStub = (KVInterface) UnicastRemoteObject.exportObject(kvServer1, servantPortNumber);
            Registry registry = LocateRegistry.createRegistry(servantPortNumber);
            registry.rebind("utils.KVInterface", kvStub);

            timestamp = new Timestamp(System.currentTimeMillis());
            serverLogger.debug("KVServer1 is listening at port " + servantPortNumber +
                    " ...   " + timestamp);
            ...
            serverLogger.error("Error creating server1.");
